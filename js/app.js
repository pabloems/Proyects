const ingresos = [
  new Ingreso("Sueldo", 500000),
  new Ingreso("Venta teléfono", 100000),
 
];

const egresos = [
  new Egreso("Renta departamento", 200000),
  new Egreso("Plan de teléfono", 20000),
  new Egreso("Ropa", 50000),
];
